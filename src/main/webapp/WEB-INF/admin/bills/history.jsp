...
<a href="/admin/users/index" class="btn btn-primary"> <span
	class="fas fa-backward"></span> Trở lại
</a>
<c:if test="${!empty list.getContent() }">
				...
				<tbody>
					<c:forEach items="${list.getContent()}" var="obj">
						<tr class="align-middle">
							...
							<td><a href="/admin/bills/detail?id=${obj.id }"
									...
									<div class="modal-dialog">
										<div class="modal-content">
											...
											<div class="modal-footer">
												...
												<a href="/admin/bills/cancel?idBill=${obj.id }"
									...
									<div class="modal-dialog">
										<div class="modal-content">
											...
											<div class="modal-footer">
												<button type="button" class="btn btn-secondary"
													data-bs-dismiss="modal">Huỷ</button>
												<a href="/admin/bills/success?idBill=${obj.id }"
		...
		<div class="card-footer">
			<div class="d-flex justify-content-center">
				<a
					...
					href="/admin/bills/history?page=0&id=${id}"> <span
					class="fas fa-backward"></span>
				</a> <a
					class="btn btn-primary me-1 ${list.getNumber()==0?'disabled':'' }"
					href="/admin/bills/history?page=${list.getNumber()-1 }&id=${id}"> <span
				...
				<a
					...
					href="/admin/bills/history?page=${list.getTotalPages()-1 }&id=${id}"> <span
